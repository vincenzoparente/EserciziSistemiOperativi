...
/* QUESTA SOLUZIONE GESTISCE LATO PADRE IL CASO CHE UN FIGLIO TERMINI PERCHE' IL FILE ASSOCIATO NON ESISTE INSTALLANDO UNA FUNZIONE HANDLER PER IL SEGNALE SIGPIPE */
#include <stdio.h>
#include <string.h>
#include <fcntl.h>
#include <sys/stat.h>
...
/* MESSO GLOBALE IN MODO DA POTERLO USARE NELLA FUNZIONE HANDLER */
int i;
int flag = 0;

void handler(int signo)
{
	printf("DEBUG-Sono il padre %d e ho ricevuto il segnale %d il valore di i e' %d e il pid e' %d\n", getpid(), signo, i);
	flag = 1;
}
